...
flowchart LR
    ...
    Worker -->|完成登记| Notify["保安通知（可插拔）<br/>Discord / Telegram / 企业微信<br/>卡片 + 确认链接"]
...
| `NOTIFY_CHANNEL` | `discord`(默认) / `telegram` / `wecom` |
| `DISCORD_WEBHOOK_URL` | Discord 频道 webhook（demo 默认通知渠道） |
